...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('noise_sources', function (Blueprint $table) {
            ...
            $table->float('31_5')->nullable();
            $table->float('63')->nullable();
            $table->float('125')->nullable();
            $table->float('250')->nullable();
            $table->float('500')->nullable();
            $table->float('1000')->nullable();
            $table->float('2000')->nullable();
            $table->float('4000')->nullable();
            $table->float('8000')->nullable();
